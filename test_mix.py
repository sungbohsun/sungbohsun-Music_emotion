...
if __name__ == '__main__':
    ...
    ax.set_title('{}-MIX_{}_{}_{}_fold{} Confusion Matrix'.format(args.CV,args.mode,args.model1,args.model1,args.fold))

    ax.set_xlabel('Predicted Labels')
    ax.set_ylabel('True Labels')

    fig.savefig('png/{}-MIX_{}_{}_{}_fold{}.png'.format(args.CV,args.mode,args.model1,args.model1,args.fold))
